...
struct ComparisonFiguresTests {
  ...
  func barsAreShares() {
    #expect(ComparisonBars.share(16, of: 28) == 16.0 / 28)
    #expect(ComparisonBars.share(7, of: 28) == 7.0 / 28)
  ...
  func sharesAreOneScale() {
    ...
    #expect(abs(ComparisonBars.share(16, of: 28) / ComparisonBars.share(7, of: 28) - 16.0 / 7) < 1e-12)
